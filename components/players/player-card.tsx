      ...
      <div className="p-5">
        <div className="flex justify-between items-start gap-3">
          <div className="flex-1 min-w-0">
            ...
            {player.email && (
              <p className="text-muted text-sm mt-0.5 truncate">{player.email}</p>
            )}
          </div>
        ...
        <div className="mt-4 pt-4 border-t border-card-border flex gap-2">
          ...
          {!player.is_user && onDelete && (
            <button
              ...
              className="p-2.5 text-muted hover:text-score-triple hover:bg-score-triple/10 rounded-lg transition-colors"
              title="Delete player"
            >
